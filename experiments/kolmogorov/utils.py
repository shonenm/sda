...
Kolmogorov流（2次元乱流）実験のためのユーティリティ関数群
- モデルの構築とロード
...
def make_chain() -> MarkovChain:
    ...
    Returns:
        KolmogorovFlow: 256×256グリッド、時間刻み0.2のKolmogorov流シミュレータ
                       周期境界条件とsin(4x)の強制項を持つ2D Navier-Stokes方程式
    """
